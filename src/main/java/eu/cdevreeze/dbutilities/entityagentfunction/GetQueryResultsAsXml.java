...
/**
 * {@link EntityAgentToElementFunction} that returns the results of a query as XML.
 * <p>
...
public final class GetQueryResultsAsXml extends AbstractGetQueryResultsAsXml {
    ...
    public GetQueryResultsAsXml(Path queryFile, List<QueryParameter> queryParameters) {
