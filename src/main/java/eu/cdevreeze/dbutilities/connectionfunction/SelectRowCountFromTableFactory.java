...
/**
 * Factory of {@link SelectRowCountFromTable} objects.
 *
 * @author Chris de Vreeze
 */
public final class SelectRowCountFromTableFactory implements JdbcConnectionToJsonObjectFunctionFactory {
    ...
    public SelectRowCountFromTable apply(List<String> args) {
        ...
        return new SelectRowCountFromTable(tableName);
    }
}
